...
export default function SettingsBar (props) {
    ...
    return (
        <div className="m-2 py-2 border-b border-zinc-700 text-white text-sm cursor-default">
            ...
            <h3 className="text-amber-300 font-medium mx-5 mt-2">Board appearance</h3>
            <div className="border-t border-zinc-700 pl-10 m-2 text-[15px]">
                <p 
            ...
            <h3 className="text-amber-400 font-medium mx-5">Play with</h3>
            <div className="border-t border-zinc-700 pl-10 m-2 text-[15px]">
                <div className={`my-1 border-b border-zinc-900 py-1 px-2`}>
                    ...
                    <div className={`${openAi && !isGameStarted ? 'flex flex-col jusitfy-center':'hidden'} py-2 px-4`}>
                        ...
                        <input className="w-[50px] rounded-md bg-zinc-300 pl-2 text-black font-medium my-2" type="number" name="difficulty" value={level} onChange={onLevelChange}/>
                        <button 
                ...
                <div className={`my-1 border-b border-zinc-900 py-1 px-2`}>
                    ...
                    <div className={`${openFriend && !isGameStarted ? 'flex flex-col justify-center':'hidden'} py-2 px-4`}>
                        ...
                        <input className="w-[57%] rounded-md bg-zinc-300 px-2 text-black font-medium my-2" type="text" name="difficulty" value={opponentName} onChange={onNameChange}/>
                        <button 
                            className="my-1 w-[55px] rounded-md border border-green-500 text-white hover:bg-green-500 font-medium py-[2px]"
            ...
            <div className="flex justify-between font-medium mx-2 px-3 py-1 border-t border-b border-zinc-700 hover:bg-zinc-700" onClick={handlePreference}>
            ...
            <div>
                <div className="flex justify-start py-1 hover:text-green-500 hover:bg-zinc-700 pl-2" onClick={() => setOpenRules(!openRules)}>
                    ...
                    <h3 className="text-amber-400 font-medium mx-2">Game Rules</h3>
                </div>
                <div className={`${openRules ? 'flex':'hidden'} p-3 border-t border-zinc-700 text-[15px]`}>
